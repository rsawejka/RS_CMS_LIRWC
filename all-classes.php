    ...
    <div class="col-md-3">
        <div class="card mb-3">
           ...
           <a href=' . espresso_event_link_url(0, false) . '>   
            <img src="' . (has_post_thumbnail(0) ? get_the_post_thumbnail_url() : get_site_url() . "/placeholder.png") . '" class="rounded-top" style="height:200px" alt="' . (get_post_meta(0, '_wp_attachment_image_alt', true) ? get_post_meta(0, '_wp_attachment_image_alt', true) : "Image of " . get_the_title()) . '">
            </a>
            <div class="p-4">
